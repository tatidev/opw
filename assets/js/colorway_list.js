...
$('figure img').on('click', function () {
    on_figure_img_click(this);
});

function on_figure_img_click(_this){
    ...
    */
    ...
    if (true /*|| !isMobile*/) {
        ...
        var pattern_name = $(obj).attr('data-name');
        var item_id = $(obj).attr('data-item-id');
        var color = $(obj).attr('data-color');
        var code = $(obj).attr('data-code');
        var href = $(obj).attr('data-src');
        var pic_hd = $(obj).attr('data-hd');
        var url_title = $(obj).attr('data-url-title');
        var slug = $(obj).attr('data-name').toLowerCase().replace(/\s+/g, '-');
        console.log(url_title);

        // Update spec href
        if ($(obj).attr('data-category') !== 'digital_styles_items') {
        ...
        //         .attr('href', '');
        // } else {
        //     var srcHd = $(obj).attr('data-src').replace('big/', '').replace('_items', '_items_hd');
