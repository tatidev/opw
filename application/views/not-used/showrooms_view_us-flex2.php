...
<div class="d-flex flex-wrap flex-row w-100 justify-content-between mt-3">
	
	<div style="flex: 1;" class='filter-dropdown-container float-left'>
	...
	<div class="mx-auto" style="flex: 1 1 450; width: 450px; margin: -32px;">
		<img class="w-100" src="<?=asset_url()."images/showroom-main.jpg"?>" />
	</div>
	<div style="flex: 1; padding: 0 17px;" class="d-flex flex-wrap flex-column">
		<?php
